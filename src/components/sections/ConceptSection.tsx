      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center mb-20">
          ...
          <div className="animate-fade-in order-2 lg:order-1">
            <div className="relative aspect-[3/4] rounded-2xl bg-gradient-to-br from-gray-800/40 to-gray-900/40 border border-gray-800 overflow-hidden">
              <div className="absolute inset-0 flex flex-col items-center justify-center p-8 text-center">
                ...
                <p className="text-sm font-semibold text-gray-400 mb-1">Photo Mohamed Henni</p>
                <p className="text-xs text-gray-600">Portrait ou photo plateau</p>
              </div>
              <div className="absolute -inset-px rounded-2xl bg-gradient-to-br from-violet-500/10 via-transparent to-transparent pointer-events-none" />
            </div>
          </div>

          {/* Text */}
          <div className="animate-fade-in-up order-1 lg:order-2">
            <p className="text-xs font-bold tracking-widest uppercase text-violet-400 mb-6">Le concept</p>
            ...
            <div className="space-y-5 text-base text-gray-400 leading-relaxed">
              <p>
                OCTOGOAL est le média football porté par <span className="text-white font-semibold">Mohamed Henni</span>, l'un des créateurs les plus influents de France avec <span className="text-violet-400 font-semibold">plus de 11 millions d'abonnés</span>.
              </p>
              <p>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 animate-fade-in-up delay-200">
          {[
            { icon: Users, value: '11M+', label: 'Abonnés cumulés', desc: 'Tous réseaux confondus', color: 'violet' },
            { icon: Tv, value: '7', label: 'Émissions live', desc: 'CAN 2025', color: 'violet' },
            { icon: Globe, value: '6', label: 'Plateformes', desc: 'YouTube, TikTok, FB, Snap...', color: 'violet' },
            { icon: Target, value: '25-34', label: 'ans — cœur de cible', desc: '60%+ de l\'audience', color: 'violet' },
          ].map((item) => {
            ...
            return (
              <div key={item.label} className="p-5 sm:p-6 rounded-2xl bg-gray-900/50 border border-gray-800 hover:border-gray-700 transition-colors">
                <Icon className="w-5 h-5 text-violet-500/70 mb-4" />
