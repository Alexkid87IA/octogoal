    ...
    <section id="emissions" className="relative py-20 sm:py-28 px-6 sm:px-8 bg-[#0a0a0f] overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-24 sm:mb-32">
          <p className="text-xs font-bold tracking-widest uppercase text-violet-400 mb-4">Les émissions live</p>
          <h2 className="font-display text-3xl sm:text-4xl md:text-5xl font-black text-white leading-tight mb-4">
            7 épisodes pendant la CAN
          </h2>
          ...
          <div className="mb-6 rounded-2xl overflow-hidden border border-gray-800 bg-black">
            ...
            <div className="flex items-center justify-between px-5 py-4 bg-gray-900/80 border-t border-gray-800">
              <div className="flex items-center gap-3">
                <span className="text-[11px] font-bold tracking-wider uppercase text-violet-400 bg-violet-500/10 px-2 py-0.5 rounded">{episodes[activeEp].ep}</span>
            ...
            {episodes.map((ep, i) => (
              <button
                ...
                className={`group relative rounded-xl overflow-hidden border transition-all ${
                  i === activeEp ? 'border-violet-500 ring-1 ring-violet-500/30' : 'border-gray-800 hover:border-gray-600'
                }`}
              >
                ...
                <div className="p-2 bg-gray-900">
                  <p className={`text-[10px] font-bold ${i === activeEp ? 'text-violet-400' : 'text-gray-500'}`}>{ep.ep}</p>
                </div>
              </button>
            ))}
          </div>
            ...
            {[
              ...
              return (
                <div key={s.label} className="p-4 sm:p-5 rounded-xl bg-gray-900/50 border border-gray-800 text-center">
                  <Icon className="w-4 h-4 text-violet-500/60 mx-auto mb-2" />
        ...
        <div>
          ...
          <p className="text-xs font-bold tracking-widest uppercase text-violet-400 mb-4">Vidéos courtes — Le format roi</p>
          <h2 className="font-display text-3xl sm:text-4xl md:text-5xl font-black text-white leading-tight mb-4">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-10">
            {[
              ...
              <div key={s.label} className="p-5 sm:p-6 rounded-2xl bg-gradient-to-br from-violet-500/5 to-gray-900/30 border border-violet-500/10 hover:border-violet-500/20 transition-colors">
                <p className="font-display text-3xl sm:text-4xl font-black text-violet-400">{s.value}</p>
          ...
          <div className="mt-10 p-6 rounded-2xl bg-gray-900/50 border border-gray-800">
            <p className="text-sm text-gray-400 leading-relaxed">
              <span className="text-white font-semibold">Sur Facebook</span>, les Reels (25,5% des posts) dominent avec <span className="text-violet-400 font-semibold">19 009 interactions</span> et <span className="text-violet-400 font-semibold">399 787 impressions</span> en moyenne par post — le format le plus performant de toute la page.
              Les <span className="text-white font-semibold">333 publications</span> ont généré <span className="text-violet-400 font-semibold">127,4M de vues</span> et <span className="text-violet-400 font-semibold">4,86M d'interactions</span>.
            </p>
          </div>
        </div>
      </div>
