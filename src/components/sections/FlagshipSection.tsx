...
export default function FlagshipSection() {
  return (
    <section id="flagship" className="relative py-16 sm:py-24 lg:py-32 px-4 sm:px-6 bg-gradient-to-b from-slate-50 via-white to-slate-50 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="text-center mb-12 sm:mb-16 lg:mb-20 animate-fade-in">
          ...
          <h2 className="text-3xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-black text-slate-900 mb-6 sm:mb-8 leading-tight">
            L'émission OCTOGOAL Live
          </h2>
          <div className="w-24 sm:w-32 h-1.5 bg-gradient-to-r from-indigo-500 via-purple-500 to-violet-500 mx-auto rounded-full"></div>
        </div>

        <div className="grid lg:grid-cols-12 gap-8 sm:gap-10 lg:gap-12 mb-12 sm:mb-16">
          ...
          <div className="lg:col-span-5 space-y-8 animate-fade-in-up">
            <div className="relative group">
              ...
              <div className="relative bg-white rounded-3xl p-6 sm:p-8 lg:p-10 shadow-2xl border border-slate-100">
                <h3 className="text-2xl sm:text-3xl md:text-4xl font-black text-slate-900 mb-6 sm:mb-8 lg:mb-10 leading-tight">Une émission premium</h3>
            ...
            <div className="relative group">
              ...
              <div className="relative bg-gradient-to-br from-indigo-600 to-purple-600 rounded-3xl p-6 sm:p-8 lg:p-10 shadow-2xl text-white border border-indigo-400/30">
                <h4 className="text-xl sm:text-2xl md:text-3xl font-black mb-5 sm:mb-8">Opérations commerciales</h4>
                <div className="space-y-4 sm:space-y-5">
                  <div className="flex items-center gap-3 sm:gap-4">
                    <div className="w-3 h-3 rounded-full bg-white flex-shrink-0 shadow-lg"></div>
                    <p className="text-base sm:text-lg lg:text-xl font-bold">Sponsorisable & brandable</p>
                  </div>
                  <div className="flex items-center gap-3 sm:gap-4">
                    <div className="w-3 h-3 rounded-full bg-white flex-shrink-0 shadow-lg"></div>
                    <p className="text-base sm:text-lg lg:text-xl font-bold">Déclinable en extraits viraux</p>
                  </div>
                  <div className="flex items-center gap-3 sm:gap-4">
                    <div className="w-3 h-3 rounded-full bg-white flex-shrink-0 shadow-lg"></div>
                    <p className="text-base sm:text-lg lg:text-xl font-bold">Un vrai rendez-vous</p>
                  </div>
                </div>
              </div>
            </div>
